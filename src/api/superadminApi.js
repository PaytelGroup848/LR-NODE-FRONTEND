...
export const generateClientKeys = async (clientId, data) => {
  const response = await axiosInstance.post(`/superadmin/clients/${clientId}/keys/generate`, data);
  return response.data;
};

export const suspendClient = async (clientId) => {
  const response = await axiosInstance.patch(`/superadmin/clients/${clientId}/suspend`);
  return response.data;
};

export const unsuspendClient = async (clientId) => {
  const response = await axiosInstance.patch(`/superadmin/clients/${clientId}/unsuspend`);
  return response.data;
};

export const sendKeyEmail = async (keyId) => {
  const response = await axiosInstance.post(`/superadmin/keys/${keyId}/send-email`);
  return response.data;
};
...
export const getPartnerStats = async (partnerId) => {
  const response = await axiosInstance.get(`/superadmin/partners/${partnerId}/stats`);
  return response.data;
};

export const generatePartnerBulkKeys = async (partnerId, data) => {
  const response = await axiosInstance.post(`/superadmin/partners/${partnerId}/keys/generate-bulk`, data);
  return response.data;
};

export const sendBulkKeysEmail = async (partnerId, batchId) => {
  const response = await axiosInstance.post(`/superadmin/partners/${partnerId}/keys/send-email`, { batchId });
  return response.data;
};

export const suspendPartner = async (partnerId) => {
  const response = await axiosInstance.patch(`/superadmin/partners/${partnerId}/suspend`);
  return response.data;
};

export const unsuspendPartner = async (partnerId) => {
  const response = await axiosInstance.patch(`/superadmin/partners/${partnerId}/unsuspend`);
  return response.data;
};
...
export const suspendKey = async (keyId) => {
  const response = await axiosInstance.patch(`/superadmin/keys/${keyId}/suspend`);
  return response.data;
};

export const unsuspendKey = async (keyId) => {
  const response = await axiosInstance.patch(`/superadmin/keys/${keyId}/unsuspend`);
  return response.data;
};
